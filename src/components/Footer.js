    ...
    <footer className='bg-indigo-600 text-white'>
      <div className="mx-auto max-w-7xl p-6 lg:px-8"> 
        <div className='grid grid-cols-1 gap-y-6 gap-x-3 sm:grid-cols-2 xl:gap-x-6'>
          <div className='py-48 pr-28'>
            <h1 className='text-4xl font-medium mb-4'>Vuoi richiedere informazioni?</h1>
            <div>
        ...
        <div className='w-full'>
          <div className='text-center'>2023 © Inprinting - Tutti i diritti riservati | P.IVA 123456789 | <Link className='hover:underline' to='#'>Privacy Policy</Link></div>
        </div>
      </div>
    </footer>
  )
